...
useEffect(() => {
  ...
  if (inStockOnly) {
    // 🔥 FIXED LINE: check the correct field for in-stock status
  ...
  // -------------------------------
  return (
    <main className="flex flex-col sm:flex-row min-h-screen bg-[#f4f4f4]">

      {/* Sidebar Filters */}
      <aside className="sm:w-1/4 p-6 bg-white border-r shadow- lg:w-1/5">
